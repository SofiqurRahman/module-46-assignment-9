  ...
  return ( 
    <div className="loginForm" style={{textAlign: 'center'}}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <br/>
        <input type="checkbox"/>
        <a className="linkLeft" href="#">Remember Me</a>
        <a className="linkColor" href="#">Forgot Password</a>
        <br/>
        <input className="logBtn" type="submit" value={newUser ? 'Logout' : 'Login'}/>
        <p>Don't have an account?<a className="linkColor" href="createAccount">Create an account</a></p>
      </form>
      <p>Or</p>
      {
